...
//       if (user) {
//         router.push("/provider/dashboard"); // Redirect if logged in
//       }
//     });
//     return () => unsubscribe();
//   }, [router]);
...
//       router.push("/provider/dashboard"); // Navigate after login
//     } catch (err: unknown) {
...
//           <h2 className="mt-4 text-3xl font-extrabold text-center text-gray-900">Provider Login</h2>
...
//           <a href="/provider/signup" className="font-semibold text-blue-600 hover:text-blue-500">
//             Sign Up
//           </a>
//         </p>
//       </div>
...
//   const [showPassword, setShowPassword] = useState(false);
//   const [error, setError] = useState("");
//   const [isAuthLoading, setIsAuthLoading] = useState(true); // Renamed state to be more specific
//   const [isLoginInProgress, setIsLoginInProgress] = useState(false); // New state for login action
...
//       } else {
//         // Only stop loading state if no user is found
...
//     e.preventDefault();
//     setError("");
//     setIsLoginInProgress(true); // Start login action loading
...
//       setError((err as Error).message);
//     } finally {
//       setIsLoginInProgress(false); // Stop login action loading
//     }
//   };
...
//               className="w-full py-3 pl-12 pr-4 border border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
//             />
//           </div>
...
//               required
//               disabled={isLoginInProgress}
//               className="w-full py-3 pl-12 pr-10 border border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
//             />
//             <div
//               className="absolute text-gray-500 -translate-y-1/2 cursor-pointer right-3 top-1/2"
//               onClick={() => setShowPassword(!showPassword)}
...
//             type="submit"
//             disabled={isLoginInProgress}
//             className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-transform hover:scale-[1.02] disabled:bg-blue-400 disabled:cursor-not-allowed"
//           >
...
//             onClick={handleGoogleLogin}
//             disabled={isLoginInProgress}
//             className="flex items-center justify-center gap-3 py-3 font-medium text-gray-800 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
//           >
//             <FcGoogle className="text-xl" />
//             {isLoginInProgress ? "Signing in..." : "Sign in with Google"}
//           </button>
//         </div>
